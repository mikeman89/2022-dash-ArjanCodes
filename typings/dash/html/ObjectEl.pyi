...
class ObjectEl(Component):
    ...
    _type = ...
    @_explicitize_args
    def __init__(self, children=..., id=..., n_clicks=..., n_clicks_timestamp=..., disable_n_clicks=..., key=..., data=..., form=..., height=..., name=..., type=..., useMap=..., width=..., accessKey=..., className=..., contentEditable=..., contextMenu=..., dir=..., draggable=..., hidden=..., lang=..., role=..., spellCheck=..., style=..., tabIndex=..., title=..., loading_state=..., **kwargs) -> None:
        ...
