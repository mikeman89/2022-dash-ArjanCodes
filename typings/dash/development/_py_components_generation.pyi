...
def generate_classes_files(project_shortname, metadata, *component_generators): # -> list[Unknown]:
    ...

def generate_class(typename, props, description, namespace, prop_reorder_exceptions=...): # -> Type[Component] | ((func: Unknown) -> ((*args: Unknown, **kwargs: Unknown) -> Unknown)):
...
def required_props(props): # -> list[Unknown]:
...
def parse_wildcards(props): # -> list[Unknown]:
...
def reorder_props(props): # -> OrderedDict[Literal['id', 'children'], Literal['']]:
...
def map_js_to_py_types_prop_types(type_object, indent_num): # -> dict[str, () -> str]:
    """Mapping from the PropTypes js type object to the Python type."""
    ...

def map_js_to_py_types_flow_types(type_object): # -> dict[str, (() -> str) | ((indent_num: Unknown) -> str)]:
    """Mapping from the Flow js types to the Python type."""
    ...

def js_to_py_type(type_object, is_flow_type=..., indent_num=...): # -> str:
