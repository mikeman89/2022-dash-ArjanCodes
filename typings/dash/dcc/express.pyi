...
def send_file(path, filename=..., type=...): # -> dict[str, Unknown | None]:
    """
...
def send_bytes(src, filename, type=..., **kwargs): # -> dict[str, Unknown | None]:
    """
...
def send_string(src, filename, type=..., **kwargs): # -> dict[str, Unknown | None]:
    """
...
def send_data_frame(writer, filename, type=..., **kwargs): # -> dict[str, Unknown | None]:
    """
